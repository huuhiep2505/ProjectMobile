...
public class WorkingRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_working_request);
        ...
        listWorking.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intentShow = new Intent(WorkingRequestActivity.this, GroupWorkingDetailActivity.class);
    ...
    public void showData(){
        List<WorkingDTO> result = dao.getListWorkingRequest(username);
        if (result.size() > 0){
